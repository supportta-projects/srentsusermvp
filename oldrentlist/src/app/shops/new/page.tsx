...
import { createShop, RENTAL_TYPES, type RentalType } from '@/lib/supabase-shops';
...
export default function NewShopPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { data, error: createError } = await createShop({
    ...
    <div className="min-h-screen bg-black">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-2">Add New Shop</h1>
          <p className="text-gray-400">Add a new shop location for your rental business</p>
        </div>
