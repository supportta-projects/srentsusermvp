  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-black border-y border-white/10 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Marquee Animation - CSS Optimized */}
        <div className="relative py-8 sm:py-12">
          ...
          <div className="flex overflow-hidden">
            <div className="flex gap-12 sm:gap-16 md:gap-20 lg:gap-24 items-center animate-marquee">
              {duplicatedCompanies.map((company, index) => (
                <div
                  key={`${company}-${index}`}
                  className="flex-shrink-0 whitespace-nowrap hover:scale-105 transition-transform duration-300"
                >
                  <span
