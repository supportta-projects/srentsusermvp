...
export default function ShopDetailPage() {
  ...
  const loadShopData = async () => {
    try {
      ...
      const shopProducts = productsData.products.filter(p => p.shopId === shopId);
    ...
    return (
      <div className="min-h-screen bg-black">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 text-center">
          ...
          <Link href="/" className="text-white hover:text-gray-300 mt-4 inline-block transition-colors">
            Back to Home
          </Link>
        </div>
      </div>
