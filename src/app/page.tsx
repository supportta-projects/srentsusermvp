        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
          <div className="text-center mb-8 md:mb-12">
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-3 md:mb-4 tracking-tight">
              ...
              <span className="gradient-green-text">Anywhere</span>
            </h1>
      ...
      {loading ? (
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 pb-12">
          {products.length === 0 ? (
            ...
            <>
              {/* Square grid - 2 columns on mobile */}
              <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2.5 sm:gap-3 md:gap-4 lg:gap-6">
